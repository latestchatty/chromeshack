# jquery v3.4.1 (MIT)
# (note to reviewers: code.jquery.com is the official source for release distributables of jQuery)
...
https://github.com/cure53/DOMPurify/blob/1.0.11/dist/purify.min.js
...
https://github.com/nolimits4web/swiper/blob/v4.5.0/dist/js/swiper.min.js
https://github.com/nolimits4web/swiper/blob/v4.5.0/dist/css/swiper.css
https://github.com/nolimits4web/swiper/blob/v4.5.0/dist/css/swiper.min.css

# webextension-polyfill 0.4.0 (MPL-2.0)
# (note to reviewers: unpkg.com is the official source of release distributables provided by Mozilla)
