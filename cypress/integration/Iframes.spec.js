...
context("Iframes", () => {
    it("open with various hosters", () => {
        ...
        cy.log("youtube opens with short-url video at offset");
        ...
        cy.log("youtube opens with long-url video");
        ...
        cy.log("youtube opens with long-url video at offset");
        ...
        cy.log("youtube opens with long-url video from playlist");
        ...
        cy.log("twitch opens with channel");
        ...
        cy.log("twitch opens with long-form clip");
        ...
        cy.log("twitch opens with short-form clip");
        ...
        cy.log("twitch opens with VOD at offset");
        ...
        cy.log("streamable opens with video");
        ...
        cy.log("xboxdvr opens with video");
