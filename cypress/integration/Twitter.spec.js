...
context("Twitter", () => {
    it("is interactive with media", () => {
        cy.log("opens with single image tweet");
        ...
        cy.log("opens with single video tweet that autopauses");
        ...
        cy.log("opens with a two image carousel");
        ...
        cy.log("opens with a quoted tweet");
        ...
        cy.log("opens a tweet thread with a single image");
        cy.window().then((win) => {
