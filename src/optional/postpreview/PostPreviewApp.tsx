...
const PostPreviewApp = memo(
  (props: { postboxElem: HTMLElement; paneMountElem: HTMLElement }) => {
    ...
    const handleToggleClick = useCallback(
      (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        e.preventDefault();
        const inputArea = postboxRef.querySelector(
          "#frm_body"
        ) as HTMLInputElement;
    ...
    useEffect(() => {
      ...
      const replyBtn = parentFullpost?.querySelector(
        ".fullpost .reply>a"
      ) as HTMLElement;
      const closeFormBtn = inputArea
        ?.closest(".postbox")
        ?.querySelector("div.closeform>a") as HTMLElement;
      ...
      const handleExternalInput = (el: HTMLInputElement) =>
        debouncedInputRef(el);
