    ...
    <Tabs>
      <div title="Media">
        <OptionGroup
          ...
          infolabel="Show multimedia links inline when clicked."
        >
          <Option
            id="media_loader"
            label="Embed media"
          ...
          <Option
            ...
            descriptions={[
              "Replace Shacknews Chatty links with embedded posts when clicked.",
            ]}
          />
          <Option
            id="auto_open_embeds"
            label="Open embedded media links by default"
          />
          <Option
            id="twitchauto"
            label="Disable Chatty Twitch Auto-play"
            descriptions={[
              "Disable auto-play on the Chatty's article Twitch embed.",
            ]}
          />
        </OptionGroup>
        <br />
      ...
      <div title="Filters">
        <OptionGroup
          label="Highlighting"
          infolabel="Color highlighting within the tree of thread replies."
        >
          <Option
      ...
      <div title="Flair">
        <OptionGroup label="[lol] Tags">
          ...
          <Option
            ...
            descriptions={[
              "Hides notices that would be shown when interacting with posts/lol-tags.",
            ]}
          />
        </OptionGroup>
        ...
        <OptionGroup label="User Flair">
          ...
          <Option
            id="reduced_color_user_icons"
            label="Reduced color user icons"
          />
        </OptionGroup>
      ...
      <div title="Extras">
        <OptionGroup label="Bells and whistles">
          <Option
            ...
            descriptions={[
              "Show the original username of shackers who changed names.",
            ]}
          />
          ...
          <Option
            id="drafts"
            label="Drafts"
            descriptions={["Automatically saves/loads unposted replies."]}
          />
          <Option
            id="templates"
            label="Templates"
            descriptions={[
              "Allows for saving/loading unposted replies as templates.",
            ]}
          />
          <Option
            id="chatty_news"
            label="Chatty News"
            descriptions={[
              "Adds a recent Shacknews articles box to the top of the Chatty.",
            ]}
          />
        </OptionGroup>
